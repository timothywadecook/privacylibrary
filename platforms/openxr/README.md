...
- **Candidate rule gaps this surfaces:** (1) is high-precision eye/face tracking *biometric* for the purposes of our rules, distinct from "sensitive personal information"? (2) does a room mesh or depth map containing a bystander's body count as "capture" under [BR-3](../../classes/bystander-respecting/README.md#normative-rules)/[BR-5](../../classes/bystander-respecting/README.md#normative-rules)? (3) when governance is split across a standard and a runtime, how should a spec attribute a Pass/Fail to the right layer?
